...
const Dashboard2 = () => {
  ...
  return (
    <div className="p-6 bg-gray-100 min-h-screen">
      <h1 className="text-3xl font-bold mb-6 text-gray-800">Dashboard Restaurante</h1>
        ...
        <div className="bg-white p-6 rounded-lg shadow-sm lg:col-span-2">
          ...
          <div className="space-y-4">
            {lowStockProducts.map((producto, index) => (
              <div key={index} className="flex items-center justify-between bg-red-50 p-4 rounded">
                <span className="font-medium">{producto.nombre}</span>
                <span className="text-red-600 font-semibold">{producto.stock} unidades</span>
              </div>
            ))}
          </div>
        </div>
